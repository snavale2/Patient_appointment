...
public class AppointmentController {
    ...
    @PostMapping
    public Appointment createAppointment(@RequestParam Long patientId, @RequestParam String appointmentTime) {
        LocalDateTime time = LocalDateTime.parse(appointmentTime);
        return appointmentService.createAppointment(patientId, time);
    }
